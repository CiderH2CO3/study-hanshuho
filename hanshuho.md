...
2027年4月の改正で、主に**マイナンバーカードを持たない海外居住者等**を対象とした新たなデジタル確認方式が追加される予定です。

### 方式「カ」
- **対象**: 住基ネットの適用を受けない海外在住者など
- **内容**: 旅券（パスポート）等のICチップ情報を読み取り、その有効性を確認する方法。

### 方式「ヨ」
- **対象**: 特定の認定を受けた事業者が提供する認証サービスを利用するケース
- **内容**: 公的個人認証（JPKI）に準ずる高度な認証スキームの活用。
